...
class Packets {
    constructor(structure) {
        ...
        const packets = {
            ...
            discoveryResponse: { flags: types.uInt32(0), clientType: types.uInt16(0), name: types.sgString(), uuid: types.sgString(), lastError: types.uInt32(0), certificateLength: types.uInt16(0), certificate: types.bytes() },
            connectRequest: { uuid: types.bytes(16, ''), publicKeyType: types.uInt16(0), publicKey: types.bytes(64, ''), iv: types.bytes(16, ''), payloadProtected: types.bytes() }, connectResponse: { iv: types.bytes(16, ''), payloadProtected: types.bytes() }, connectRequestProtected: { userHash: types.sgString(''), jwt: types.sgString(''), connectRequestNum: types.uInt32(0), connectRequestGroupStart: types.uInt32(0), connectRequestGroupEnd: types.uInt32(1) },
            ...
            heartBeat: { lowWatermark: types.uInt32(0), processedList: types.sgList('processedList', []), rejectedList: types.sgList('rejectedList', []) },

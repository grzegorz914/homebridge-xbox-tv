	...
	async getAuthorizationState() {
		try {
			...
			try {
				...
				const debug = !remoteManagementEnabled ? this.log(`Device: ${this.host} ${this.name}, remote management not enabled, please check your console settings!!!.`) : false;
			} catch (error) {
